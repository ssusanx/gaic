...
<style type="text/css">
#real tr:nth-child(odd)		{ background-color:#eee; }
#real tr:nth-child(even)		{ background-color:#fff; }
</style>
<script>
function loadAjaxPage(containerId, action, value){
	...
	loadXMLDoc(action + value, function() {displayContent(containerId); });
}
...
<div id="container">
	<div id="header">
		...
		<div id="cart" >
		<a href="cart.htm" ><img src="./image/Shopping-Cart.png" />View Cart</a>
		</div>
...
<table width="600px">
<tr>
	<td colspan="8" align= "center" style="font: 18px Georgia, Times New Roman, Times, serif;" >Extra Strong Twist Tie Trash Bags 
	</td>
...
<tr>
  ...
  <img src="http://www.thewebsqueeze.com/wp-content/uploads/borders/rounded-corner-image.jpg" alt="Klematis" width="315" >
  </a>
	</td>
	<td colspan="4">It all starts by allowing us to quote your packaging requirements. 
	Through the discovery phase of quoting we try to understand the exact film properties needed for your packaging application. 
	To get started just call 1-(626)350-5900 and one of our Flexible Packaging Experts will help you through the quoting process.
	</td>
</tr>
...
<tr id="real">
	<td>Picture</td>
	<td>3546657</td>
	<td>Description afljf ajdfla askjhajf</td>
	<td>465</td>
	
	<td>474</td>
	<td>$45.60</td>
	<td><input type="text" size = "6" id = "qty<%=i%>" name="qty<%=i%>" /></td>
	<td><input type="button" size = "8" value ="Add to Cart" onclick="javascript:loadAjaxPage('addToCartBox', 'addToCart.htm', ''); "/>
	</td>
...
<div id="addToCartBox" class="addToCartBox">
</div>		
<div id="footer">
<div class = "row">
	<div class = "address">
